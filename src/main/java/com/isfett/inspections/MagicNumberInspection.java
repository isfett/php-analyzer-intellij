...
public class MagicNumberInspection extends LocalInspectionTool { //PhpInspection
    ...
    public boolean PROCESSOR_IGNORE_FOR_LOOP = false;
    public boolean PROCESSOR_IGNORE_MINUS_ONE = false;
    public boolean PROCESSOR_IGNORE_ONE = false;
    public boolean PROCESSOR_IGNORE_ZERO = false;

    JPanel optionsPanel;
    Gson gson;
    private boolean isRunning = false;

    public MagicNumberInspection() {
        this.gson = new Gson();
    }
    ...
    public JComponent createOptionsPanel() {
        ...
        */
        ...
        this.addCheckbox("IgnoreForLoop", PROCESSOR_IGNORE_FOR_LOOP, processorsPanel, (isSelected) -> PROCESSOR_IGNORE_FOR_LOOP = isSelected);
        this.addCheckbox("IgnoreMinusOne", PROCESSOR_IGNORE_MINUS_ONE, processorsPanel, (isSelected) -> PROCESSOR_IGNORE_MINUS_ONE = isSelected);
        this.addCheckbox("IgnoreOne", PROCESSOR_IGNORE_ONE, processorsPanel, (isSelected) -> PROCESSOR_IGNORE_ONE = isSelected);
        this.addCheckbox("IgnoreZero", PROCESSOR_IGNORE_ZERO, processorsPanel, (isSelected) -> PROCESSOR_IGNORE_ZERO = isSelected);
    ...
    private String buildProcessors()
    {
        ...
        if (PROCESSOR_IGNORE_FOR_LOOP) {
            processorNameList.add("IgnoreForLoop");
        }

        if (PROCESSOR_IGNORE_MINUS_ONE) {
            processorNameList.add("IgnoreMinusOne");
        }

        if (PROCESSOR_IGNORE_ONE) {
            processorNameList.add("IgnoreOne");
        }

        if (PROCESSOR_IGNORE_ZERO) {
            processorNameList.add("IgnoreZero");
        }
    ...
    public ProblemDescriptor[] checkFile(@NotNull PsiFile file, @NotNull InspectionManager manager, boolean isOnTheFly) {
        System.out.println("RUN CHECKFILE");
        ...
        ArrayList<PhpAnalyzerMagicNumberDetectorModel> violations = checkMagicNumberAnalyzer(file, tempFile, provider, manager.getProject());
        if (null != violations && !violations.isEmpty()) {
            System.out.println("not Empty");
            for (PhpAnalyzerMagicNumberDetectorModel violation: violations)  {
    ...
    private ArrayList<PhpAnalyzerMagicNumberDetectorModel> checkMagicNumberAnalyzer(PsiFile file, File tempFile, PHPAnalyzerSettingsProvider provider, Project project)
    {
    ...
    private ArrayList<PhpAnalyzerMagicNumberDetectorModel> getViolationsFromExport(PsiFile file, File tempFile)
    {
        String fileContents = "";
        try {
        ...
        Type collectionType = new TypeToken<ArrayList<PhpAnalyzerMagicNumberDetectorModel>>(){}.getType();
        ArrayList<PhpAnalyzerMagicNumberDetectorModel> items  = gson.fromJson( fileContents , collectionType);
        return items;
    }
